...
var LogueGUI = function (synth)
{
    ...
    function onknob (knob, value, e) {
        ...
        let paramID;
        if (knob.id == "shape") {
            shapeValue1 = value; paramID = 6;
            value *= 10;
        }
        else if (knob.id == "sshape") {
            shapeValue2 = value; paramID = 7;
            value *= 10;
        }
        ...
        console.log(JSON.parse(JSON.stringify(shapeValue1)) + " " + JSON.parse(JSON.stringify(shapeValue2)));
    }
